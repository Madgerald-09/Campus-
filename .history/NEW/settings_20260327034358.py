...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres',
        'PASSWORD': 'YOUR_REAL_SUPABASE_PASSWORD_HERE',  # <--- PASTE YOUR PASSWORD HERE
        'HOST': 'db.iejxdwogyrqgjilbjkjl.supabase.co',   # <--- This is your host
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require', # Supabase requires this secure connection
        },
    }
}
